  ...
  (setq-default
   ...
   '(html
     ...
     (xclipboard :variables
                 xclipboard-copy-command "win32yank.exe -i"
                 xclipboard-paste-command "win32yank.exe -o"
     )
     eww
     pdf
     ;; (shell :variables
...
(with-eval-after-load 'org
  ...
  (setq org-capture-templates
      '(("s" "Stuff" entry (file+headline "~/org/gtd/stuff.org" "Stuff")
         "* TODO %?\n"))
  )
  (setq org-refile-targets (quote (("~/org/gtd/projects.org" :maxlevel . 2)
                                 ("~/org/gtd/someday.org" :maxlevel . 2)
                                 ("~/org/gtd/waiting.org" :maxlevel . 2)))
  )
